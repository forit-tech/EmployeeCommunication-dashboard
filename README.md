...
- 🖥️ [Интерфейс системы](#%EF%B8%8F-интерфейс-системы)
- 🧠 [Граф связей](#-граф-связей)
- 🎛️ [Фильтры и детализация](#%EF%B8%8F-фильтры-и-детализация)
- ⚙️ [Стек и архитектура](#%EF%B8%8F-стек-и-архитектура)
- 🧩 [Структура проекта](#-структура-проекта)
- 🛠️ [Как запустить локально](#%EF%B8%8F-как-запустить-локально)
- 🌐 [Деплой](#-деплой))
